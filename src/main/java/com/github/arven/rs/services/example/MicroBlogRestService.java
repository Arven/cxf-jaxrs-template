...
@Path("/v1")
@DeclareRoles({"rest-user", "anonymous"})
public class MicroBlogRestService {
    ...
    @Path("/user/{name}") @DELETE @RolesAllowed({"rest-user"})
    ...
    @Path("/user/{name}/friends/{friend}") @PUT @RolesAllowed({"rest-user"})
    ...
    @Path("/user/{name}/friends/{friend}") @DELETE @RolesAllowed({"rest-user"})
    ...
    @Path("/post") @POST @RolesAllowed({"rest-user"})
    ...
    @Path("/group") @POST @RolesAllowed({"rest-user"})
    ...
    @Path("/group/{name}") @DELETE @RolesAllowed({"rest-user"})
    ...
    @Path("/group/{name}/join") @POST @RolesAllowed({"rest-user"})
